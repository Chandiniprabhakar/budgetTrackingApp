...
import { Button } from '@/components/ui/button';import { download, generateCsv, mkConfig } from "export-to-csv"
...
export const columns: ColumnDef<TransactionHistoryRow>[] = [
    {
        ...
        cell: ({row}) => (
            <div className="flex gap-2 capitalize">
                ...
                <div className="captialize">{row.original.category}</div>
            </div>
        ),
    },
    {
        ...
        cell: ({row}) => (
            <div className="captialize">{row.original.description}</div>    
        ),
    },
    {
        accessorKey: "date",
